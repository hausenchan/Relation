...
- 人脉管理将已有“公司”列前移到“姓名”和“圈子”之间；公司优先显示 `company`，为空时回退
  `current_company`，存量数据无需迁移。
- 互动记录新增“公司”列，核心顺序为“圈子 / 公司 / 姓名 / 日期”；移动端卡片和互动详情同步展示。
